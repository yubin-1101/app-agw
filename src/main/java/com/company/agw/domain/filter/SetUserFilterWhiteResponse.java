...
public class SetUserFilterWhiteResponse {
    ...
    public static SetUserFilterWhiteResponse success(
            String userID,
            List<List<Object>> whiteNUM,
            List<List<Object>> whitePattern,
            List<List<Object>> whiteNUMAddr
    ) {
        return SetUserFilterWhiteResponse.builder()
                .userID(userID)
    ...
    public static SetUserFilterWhiteResponse fail(String userID, Integer retCode, String retMsg) {
        return SetUserFilterWhiteResponse.builder()
    ...
    public static SetUserFilterWhiteResponse notJoined() {
